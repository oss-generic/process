...
* [x] PR name follows the link:FormatsAndConventions.md#pr[PR title convention].
...
* [x] PR branch name follows the link:FormatsAndConventions.md#branch[branch naming convention].
* This is a soft requirement. Encourage the dev to follow the convention in future PRs.
* [x] Meets our link:FormatsAndConventions.md#commit-organization[requirements for commit organization].
...
** [x] Commit messages follow link:FormatsAndConventions.md#commit-messages[our requirements] .
