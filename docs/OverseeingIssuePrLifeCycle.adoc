...
* any one with sufficient privileges can add labels based on the link:DefiningLabels.md[project's definition of each label].
...
* A PR should have **1 or more `reviewers`**. See link:ReviewingPrs.md[Reviewing PRs].
...
review from the PM.
* After the PM has approved the PR, it can be merged. See link:MergingPrs.md[Merging PRs].
